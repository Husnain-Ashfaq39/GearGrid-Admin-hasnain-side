// src/components/VerticalLayout.js
    ...
    */
    ...
    const filterMenuItems = (items, userRoles) => {
        return items.reduce((acc, item) => {
            ...
            let newItem = { ...item };
            if (item.subItems) {
                newItem.subItems = filterMenuItems(item.subItems, userRoles);
            ...
            if (item.childItems) {
                newItem.childItems = filterMenuItems(item.childItems, userRoles);
                if (newItem.childItems.length === 0) {
                    return acc;
                }
            }
